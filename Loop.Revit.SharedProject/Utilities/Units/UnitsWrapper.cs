...
namespace Utilities.Units
{
    ...
    public static class RevitUnitTypes
    {
        ...
        public static readonly RevitUnit FractionalFeet = new RevitUnit(UnitTypeId.Feet, SpecTypeId.Length, "Fractional Feet", new List<string> { "' \"", "ft in" }, new List<double> { 1.0/12, 0.5/12, 0.25 / 12, 0.125 / 12, 0.0625 / 12, 0.03125 / 12, 0.015625 / 12, 0.0078125 / 12, 0.00390625 / 12 });
        ...
        public static readonly RevitUnit Millimeters = new RevitUnit(UnitTypeId.Millimeters, SpecTypeId.Length, "Millimeters", new List<string> { "mm" },new List<double> { 1, 0.1, 0.001, 0.001});
