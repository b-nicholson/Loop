...
namespace Loop.Revit.Utilities.Wpf
{
    public static class TextBlockHighlighter
    {
        ...
        public static readonly DependencyProperty IsHighlightingEnabledProperty =
            DependencyProperty.RegisterAttached("IsHighlightingEnabled", typeof(bool), typeof(TextBlockHighlighter),
                new PropertyMetadata(true, new PropertyChangedCallback(SelectText)));

        public static void SetIsHighlightingEnabled(DependencyObject obj, bool value)
        {
            obj.SetValue(IsHighlightingEnabledProperty, value);
        }

        public static bool GetIsHighlightingEnabled(DependencyObject obj)
        {
            return (bool)obj.GetValue(IsHighlightingEnabledProperty);
        }
        ...
        {
            if (d == null || !GetIsHighlightingEnabled(d)) return;
            if (d == null) return;
