...
namespace Loop.Revit.FourthButton
{
    public class DockablePanelViewModel : ViewModelBase
    {
        ...
        public DockablePanelViewModel()
        {
            ...
            Messenger.Default.Register<AddedElementMessage>(this, OnAddedElementsMessage);
        }

        private void OnAddedElementsMessage(AddedElementMessage obj)
        {
        ...
        {
            var filepath = DialogUtils.SelectSingleFile();
